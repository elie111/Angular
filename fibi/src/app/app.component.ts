  ...
  ngAfterViewInit() {
    ...
    this.browserOnly(() => {
      ...
      let gradient = am5.LinearGradient.new(root, {
        stops: [{
          color: am5.color("#C5DAF1")
        },{ color: am5.color("#18DC8")}, {
          
          color: am5.color("#053A72")
        },{
          color: am5.color("#C5DAF1")
        }]
      });
      ...
      volumeSeries.columns.template.adapters.add("fill", function (fill, target) {
        ...
        if (dataItem) {
          return stockChart.getVolumeColor(dataItem, am5.color("#D0021B"), am5.color("#2BBF66"));
        }
        return fill;
      })
      ...
      let gradient2 = am5.LinearGradient.new(root, {
        stops: [{
      ...
      function getNewSettings(series: any) {
        ...
        am5.array.each(["name", "valueYField", "highValueYField", "lowValueYField", "openValueYField",
          "calculateAggregates", "valueXField", "xAxis", "yAxis", "legendValueText", "stroke", "fill"], function (setting: any) {
      ...
      function setSeriesType(seriesType: any) {
        ...
        let newSettings: any = getNewSettings(currentSeries);
      ...
      let ps = am5stock.PeriodSelector.new(root, {

        stockChart: stockChart,
        periods: [
         // { timeUnit: "day", count: 1, name: "יום" },
          { timeUnit: "day", count: 7, name: "שבוע" },
          { timeUnit: "month", count: 1, name: "חודש" },
          { timeUnit: "month", count: 6, name: "6 חודשים" },
          { timeUnit: "month", count: 12, name: "שנה" },
          { timeUnit: "month", count: 60, name: "5 שנים" }
        ]
      ...
      valueSeries.events.once("datavalidated", function() {
        ps.selectPeriod({ timeUnit: "month", count: 1, name: "חודש" });
      });
    ...
    //  ps.selectPeriod(defperiod);
        //  ps._highlightPeriod({ timeUnit: "day", count: 7, name: "שבוע" });
